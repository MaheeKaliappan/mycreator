...
public class StudentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(uri.contains("addnewuser")&&(request.getMethod().equals("GET")))
		{
		...
		else if(uri.contains("studentdetails")&&(request.getMethod().equals("GET")))
		{
		...
		if(uri.contains("addnewuser")&&(request.getMethod().equals("POST")))
		{
			User user = new User();
		...
		else if(uri.contains("studentdetails")&&(request.getMethod().equals("POST")))
		{
