...
<br>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
	 <li><a href="#"><span class="glyphicon glyphicon-user"></span> <%session.getAttribute("userFirstName");session.getAttribute("userLastName"); %></a></li>
	...
	<br><br>
	<div class="container">
		<h2><center>Add Department</center></h2>
